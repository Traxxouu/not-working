    ...
    <Container>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-white/60 text-sm">Plateforme citoyenne pour une ville plus accessible.</p>
        </div>
        <div>
          <h4 className="font-medium mb-4 text-sm">Produit</h4>
          <ul className="space-y-2 text-sm text-white/60">
            <li>Carte</li><li>Signaler</li><li>Catégories</li>
          </ul>
        </div>
        <div>
          <h4 className="font-medium mb-4 text-sm">Équipe</h4>
          <ul className="space-y-2 text-sm text-white/60">
            <li>Maël Barbe</li><li>Hugo</li><li>Elisei</li>
          </ul>
        </div>
        <div>
          <h4 className="font-medium mb-4 text-sm">Projet</h4>
          <ul className="space-y-2 text-sm text-white/60">
            <li>EFREI B2 — 2026</li><li>GitHub</li>
          </ul>
        </div>
      </div>
